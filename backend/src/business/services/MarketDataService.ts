...
export class MarketDataService {
  ...
  private tickers: Ticker[] = [
    ...
    { symbol: 'XAU/USD', name: 'Gold', basePrice: 2350.50, type: 'Metals', isFavorite: true, inPortfolio: true, icon: 'https://assets.coingecko.com/coins/images/10481/small/tether-gold.png|https://flagcdn.com/w40/us.png' },
    { symbol: 'XAG/USD', name: 'Silver', basePrice: 28.30, type: 'Metals', isFavorite: false, inPortfolio: false, icon: 'https://assets.coingecko.com/coins/images/17496/small/kinesis-silver.png|https://flagcdn.com/w40/us.png' },
